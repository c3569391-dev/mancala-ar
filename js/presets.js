 ...
 * Each returns { board:int[16], current:'A'|'B', highlight:[pitIndex...] }.
...
(function () {
  ...
  window.MancalaPresets = {
     ...
     * the opposite pit 11 holds 4 seeds → capture of 5 into Player A's store.
     */
    captureDemo: function () {
      return {
        //     0  1  2  3  4  5  6   7(A)  8  9 10 11 12 13 14  15(B)
        board: [3, 0, 0, 0, 4, 4, 4,  0,   4, 4, 4, 4, 4, 4, 4,  0],
        current: 'A',
        highlight: [0]
      };
    },
    ...
    /*
     * Extra Turn Demo — Player A to move, tap pit 4 (3 seeds).
     * Sows into 5,6,7. The last seed lands in Player A's own store (7)
     * → extra turn.
     */
    extraTurnDemo: function () {
      return {
        //     0  1  2  3  4  5  6   7(A)  8  9 10 11 12 13 14  15(B)
        board: [4, 4, 4, 4, 3, 4, 4,  0,   4, 4, 4, 4, 4, 4, 4,  0],
        current: 'A',
        highlight: [4]
      };
    },
    ...
    quiz1: function () {
      return {
        //     0  1  2  3  4  5  6   7(A)  8  9 10 11 12 13 14  15(B)
        board: [2, 0, 1, 3, 0, 2, 1, 24,   1, 2, 0, 1, 2, 1, 0, 20],
        current: 'A',
        highlight: [],
        answer: 'A'
      };
    ...
    quiz2: function () {
      return {
        //     0  1  2  3  4  5  6   7(A)  8  9 10 11 12 13 14  15(B)
        board: [0, 1, 0, 2, 0, 1, 2, 16,   3, 0, 2, 1, 0, 4, 1, 12],
        current: 'B',
        highlight: [],
